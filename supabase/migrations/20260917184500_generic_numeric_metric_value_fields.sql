-- Allow aggregate Metric Qualification to sum any mapped numeric HubSpot Deal field.
-- This keeps the metric engine aligned with the rule-builder mapping contract instead of a hard-coded field whitelist.
