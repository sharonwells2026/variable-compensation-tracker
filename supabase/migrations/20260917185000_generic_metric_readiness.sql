-- Readiness must use the same mapped-numeric-field contract as the metric runtime.
-- Preserve the existing readiness implementation, then remove only stale value-field blockers
-- when the configured field is a currently mapped numeric Deal property.
