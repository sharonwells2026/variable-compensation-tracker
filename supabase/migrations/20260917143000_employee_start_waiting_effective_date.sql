...
-- Plan applicability UI needs the authoritative employee start date so it can
-- show start date + waiting period = effective date instead of asking admins
-- to manually calculate or re-enter the effective date.
