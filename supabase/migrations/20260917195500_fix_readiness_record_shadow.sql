-- Fix PL/pgSQL record/table-alias shadowing in readiness validation.
...
begin
  ...
  select count(*) into v_component_count from public.comp_plan_components pc where pc.plan_version_id=selected_plan_version_id and pc.is_active=true;
