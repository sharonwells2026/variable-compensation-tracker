-- When an object becomes mapped/eligible, immediately backfill all properties
-- already known from the HubSpot sync into the compensation rule field catalog.
...
begin
  ...
  where p.internal_object_key=target_object_type
    and p.hubspot_object_type=target_hubspot_object_type
