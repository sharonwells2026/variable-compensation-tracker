...
begin
  ...
  -- Create first. If approvers are still pre-invite, the new version remains draft
  -- and the current workflow stays untouched until activation is actually possible.
