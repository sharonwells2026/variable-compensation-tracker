...
begin
  ...
  select jsonb_build_object(
    ...
    'earnings',coalesce((select jsonb_agg(jsonb_build_object(
      'earning_id',earning.id,'plan_component_id',earning.plan_component_id,'component_name',component.name,'component_code',component.component_code,'earning_name',earning.earning_name,'source_external_id',earning.source_external_id,'source_url',earning.source_url,'earned_date',earning.earned_date,'earned_amount',earning.earned_amount,'eligibility_status',earning.eligibility_status,'eligible_date',earning.eligible_date,'eligible_amount',earning.eligible_amount,'employee_verification_status',earning.employee_verification_status,'manager_approval_status',earning.manager_approval_status,'payment_status',earning.payment_status,'paid_amount',earning.paid_amount,'source_snapshot',earning.source_snapshot
