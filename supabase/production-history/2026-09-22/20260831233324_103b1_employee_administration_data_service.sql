  ...
  from (
    select jsonb_build_object(
      ...
      'readiness_reasons',to_jsonb(array_remove(array[
        case when pr.id is null then 'Application access has not been provisioned.' when not pr.is_active then 'Application access is inactive.' end,
...
comment on function public.get_employee_administration_data() is '103B.1 permission-controlled employee administration readiness read model.';