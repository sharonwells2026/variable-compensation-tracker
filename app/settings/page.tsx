...
export default function SettingsPage(){
 ...
 if(!canMapping&&!canManage)return <main style={{padding:28,fontFamily:"Inter,Arial,sans-serif"}}><h1>Settings</h1><p>You do not have permission to view configuration settings.</p></main>;
 return <main style={{minHeight:"100vh",background:"#f5f7fa",padding:28,fontFamily:"Inter,Arial,sans-serif",color:"#051b34"}}><div style={{maxWidth:1180,margin:"0 auto"}}>
