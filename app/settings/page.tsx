...
import {ArrowRight,CircleDollarSign,CircleHelp,Database,RefreshCw,ShieldCheck} from "lucide-react";
...
export default function SettingsPage(){
 ...
 const cards=useMemo(()=>[
  ...
  canManage?{href:"/settings/payment-condition-mapping",icon:<CircleDollarSign size={21}/>,eyebrow:"BUSINESS CONCEPT",title:"Customer Payment Mapping",text:"Define which HubSpot field currently means a customer has paid so compensation plans do not have to hardcode that process."}:null,
 ...
 return <main className="eng-page"><div className="eng-page__shell">
  ...
  <header className="eng-page-header"><div className="eng-page-header__main"><span className="eng-page-header__eyebrow">CONFIGURATION</span><h1>Settings</h1><p className="eng-page-header__lede">Configure source data, rule inputs, business mappings, administrator guidance, and access controls that govern how compensation is calculated and managed.</p></div></header>
