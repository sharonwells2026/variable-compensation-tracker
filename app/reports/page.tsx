...
export default function ReportsPage(){
 ...
 return <AdminShell section="reports" title="Reports & Analytics" description="Compensation performance, operational health, and export-ready analysis.">
   ...
   <div className="two">
     <section className="card panel"><div className="panel-head"><div><h2>Compensation reporting model</h2><p>Reports will use the same effective-dated earning, eligibility, approval, and payment records as operational screens.</p></div><FileBarChart size={20}/></div><div className="setting-ownership"><div><b>Employee & team performance</b><span>Earned, eligible, approved, paid, attainment, targets, components, and trends.</span></div><div><b>Company compensation cost</b><span>Accrued liability, payable amounts, payment timing, plan/program cost, and forecast.</span></div><div><b>Plan effectiveness</b><span>Performance by plan, component, role, business unit, source, period, and employee.</span></div><div><b>Exceptions & controls</b><span>Missing source data, ownership conflicts, reconciliation gaps, overrides, holds, and unresolved approvals.</span></div></div></section>
     <section className="card panel"><div className="panel-head"><div><h2>Current data readiness</h2><p>Only measures backed by synchronized or calculated records should appear as authoritative.</p></div><Database size={20}/></div><div className="setting-ownership"><div><b>HubSpot source health</b><span>{data.deals?`${data.deals.toLocaleString()} deals and ${data.companies.toLocaleString()} companies are available for analysis.`:"Source counts are not currently available."}</span></div><div><b>Variable compensation calculations</b><span>Compensation earnings, eligibility, approvals, payroll liability, and attainment should populate here only after the calculation and reconciliation layers are validated.</span></div><div><b>Historical payroll</b><span>Prior payments must remain distinguishable from current calculated liability so reports cannot accidentally overstate amounts owed.</span></div></div></section>
   </div>
   <section className="card panel"><div className="panel-head"><div><h2>Best-in-class report library</h2><p>The report IA is established now; each report will become interactive as its underlying operational data is activated.</p></div><BarChart3 size={20}/></div><div className="role-grid"><article><b>Compensation Summary</b><small>Earned → eligible → approved → scheduled → paid by period and employee.</small></article><article><b>Attainment & Targets</b><small>Quota, book, milestone, component, and goal attainment over time.</small></article><article><b>Payroll Liability</b><small>Approved/eligible liability, holds, upcoming payments, and aging.</small></article><article><b>Plan Performance</b><small>Cost and outcomes by plan, version, component, employee, and business unit.</small></article><article><b>Exception Analysis</b><small>Unmatched records, calculation flags, source changes, disputes, and overrides.</small></article><article><b>Audit & Change Report</b><small>Plan, calculation, approval, access, AI-assisted, and payment changes.</small></article></div></section>
 </AdminShell>
}
