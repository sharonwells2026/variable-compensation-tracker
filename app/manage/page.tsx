...
export default function ManagePage(){
  ...
  return <main style={{minHeight:"100vh",background:"#f5f7fa",padding:28,fontFamily:"Inter,Arial,sans-serif",color:"#051b34"}}><div style={{maxWidth:1250,margin:"0 auto"}}>
    ...
    <section style={{background:"#eef7ff",border:"1px solid #cfe3f7",borderRadius:12,padding:14}}><b>Consolidated management UI is now authoritative.</b><p style={{margin:"3px 0 0",color:"#4f6274"}}>The original root prototype remains temporarily for employee/self-service features while we validate the dedicated routes. Management workflows, earnings, exceptions, submissions, payments, employee readiness, plans, workflow, reconciliation, HubSpot, users, and audit now have dedicated live screens.</p></section>
  </div></main>
}
